...
import { updateQuiz as updateQuizRedux } from "../../quizzesReducer";
import { updateQuiz as updateQuizAPI } from "../../client";
import MultipleChoice from "./MultipleChoiceQuestionEditor";
import Blanks from "./FillInBlanksEditor";
import TrueFalse from "./TrueFalse";
import "./index.css";
...
function QuestionsList() {
  ...
  return (
    <div>
      <Chip
        label={`Tentative total points: ${calculateTotalPoints(
          quizData.questions
        )}`}
        variant="outlined"
        color="error"
